...
extern u32 rolling_chcksum_akl(u8 * const ptr,u32 * const aklz,u32 * const bklz,u32 blk_len);
extern u32 rolling_chcksum_akl_plus_1(u8 * p,u32 * const akl,u32 * const bkl,u32 blk_len);
#endif
